...
namespace MyList
{
    ...
    public sealed partial class NewPage : Page
    {
        ...
        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MainPage.allItem.UpdateTodaItem("", pic.Source as BitmapImage, MySlider.Value, GetImage.getPicClass.imgName, titleText.Text, detailText.Text, DatePicker.Date, this.ViewModel.isChecked);
                this.ViewModel = null;
                Message = "更新成功!";
                GetImage.getPicClass.imgName = "";
                Frame rootFrame = Window.Current.Content as Frame;
        ...
        */
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            ...
            if(suspending == true)
            {
                ...
                //composite["image"] = pic.Source;
                composite["isSelected"] = ViewModel == null ? false : true;
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            else
            {
                ...
                if (ApplicationData.Current.LocalSettings.Values.ContainsKey("NewPage"))
                {
                    ...
                    bool isSelected = (bool)composite["isSelected"];
                    if (isSelected)
                        createButton.Content = "Update";
